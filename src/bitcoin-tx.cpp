...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s taler-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  taler-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded taler transaction") + "\n" +
              "  taler-tx [options] -create [commands]   " + _("Create hex-encoded taler transaction") + "\n" +
              "\n";
